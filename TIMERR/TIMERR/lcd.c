...
void reverse_number(U16 number)
{
	U8 dig1=(char)(number/1000);           dig1 = dig1+48;
	U8 dig2= (char)(number%1000/100);      dig2 = dig2+48;
	U8 dig3 =(char)(number%1000%100/10);   dig3 = dig3+48;
	U8 dig4 =(char)(number%1000%100%10);   dig4 = dig4+48;
